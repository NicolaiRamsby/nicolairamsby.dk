...
(function($) {
	"use strict";
		...
		$('#clock-countdown').countdown('2017/06/24 12:00:00').on('update.countdown', function(event) {
			var $this = $(this).html(event.strftime(''
				+ '<div class="counter-container"><div class="counter-box first"><div class="number">%-D</div><span>Dage</span></div>'
				+ '<div class="counter-box"><div class="number">%H</div><span>Timer</span></div>'
				+ '<div class="counter-box"><div class="number">%M</div><span>Minutter</span></div>'
				+ '<div class="counter-box last"><div class="number">%S</div><span>Sekunder</span></div></div>'
			));
		});
